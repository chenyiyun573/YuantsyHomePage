      ...
      <section className="relative">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="py-12 md:py-20">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-14">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">整理世界-源子RAG搜索</h2>
              <p className="text-lg text-gray-700">通过检索增强生成革新您的搜索体验</p>
            </div>
            ...
            {/* <!-- Grid --> */}
            <div className="grid lg:grid-cols-3 overflow-hidden border-y [border-image:linear-gradient(to_right,transparent,theme(colors.slate.200),transparent)1] [&>*]:p-6 pb-12 md:[&>*]:px-10 md:[&>*]:py-12 [&>*]:relative [&>*]:before:absolute [&>*]:before:bg-gradient-to-b [&>*]:before:from-transparent [&>*]:before:via-gray-200 [&>*]:before:[block-size:100%] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-inline-start:-1px] [&>*]:before:[inset-block-start:0]">
              <article>
                <h3 className="font-medium flex items-center space-x-2 mb-2">
                  ...
                  <span>Smart Retrieval 智能检索</span>
                </h3>
                <p className="text-[15px] text-gray-700">Combine cutting-edge AI with traditional search to find the most relevant and accurate information. <br></br>结合前沿人工智能与传统搜索技术，寻找最相关且最准确的信息。</p>
              </article>
              <article>
                <h3 className="font-medium flex items-center space-x-2 mb-2">
                  ...
                  <span>Context-Aware 情境感知</span>
                </h3>
                <p className="text-[15px] text-gray-700">Understands your queries better by integrating vast knowledge bases with real-time data. <br></br>通过整合庞大的知识库与实时数据，更好地理解您的查询需求。</p>
              </article>
              <article>
                <h3 className="font-medium flex items-center space-x-2 mb-2">
                  <svg className="fill-blue-500" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                  ...
                  <span>Enhanced Accuracy 精确</span>
                </h3>
                <p className="text-[15px] text-gray-700">Delivers precise and comprehensive answers, optimizing decision-making processes. <br></br>提供精确而全面的答案，优化决策过程。</p>
              </article>
            </div>
