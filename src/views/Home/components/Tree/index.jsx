    ...
    <>
      ...
      <section className="text-center">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <h1 className="text-4xl md:text-4xl font-bold mb-6 border-y [border-image:linear-gradient(to_right,transparent,theme(colors.slate.300/.8),transparent)1]" data-aos="zoom-y-out" data-aos-delay="150">
            Knowledge Tree 知识树<br className="hidden lg:block" />
          </h1>
          <p className="text-lg text-gray-700 mb-8" data-aos="zoom-y-out" data-aos-delay="300">
