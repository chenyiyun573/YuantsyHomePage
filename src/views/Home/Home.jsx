              ...
              <div className="text-center pb-12 md:pb-16">
                ...
                <div className="max-w-3xl mx-auto">
                  <p
                    ...
                    data-aos-delay="300"
                  >
                    Yuantsy Desktop Agent is an AI powered remote control
                    software that can help you to do anything you can do with a
                    computer.
                  </p>
        ...
        <section>
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <p
              ...
              data-aos-delay="300"
            >
              Know the world better. Knowledge Tree will be the knowledge
              platform both for agentic AIs and human beings.{" "}
            </p>
              ...
              <div>
                ...
                <div className="flex justify-center">
                  ...
                  >
                    ...
                    <button
                      id="tab-1"
                      className={`flex-1 flex items-center gap-2.5 text-sm font-medium h-8 px-3 rounded-lg whitespace-nowrap  focus-visible:ring focus-visible:ring-blue-300 focus-visible:outline-none transition-colors ${
                        activeTab === 1
                    ...
                    >
                      <svg
                        className={`${
                          activeTab === 1 ? "text-gray-400" : "text-gray-500"
                        } fill-current`}
                    ...
                    >
                      <svg
                        className={`${
                          activeTab === 2 ? "text-gray-400" : "text-gray-500"
                        } fill-current`}
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
                    ...
                    >
                      <svg
                        className={`fill-current ${
                          activeTab === 3 ? "text-gray-400" : "text-gray-500"
                        }`}
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
                    ...
                    >
                      <svg
                        className={`fill-current ${
                          activeTab === 4 ? "text-gray-400" : "text-gray-500"
                        }`}
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
                ...
                <div className="relative flex items-center justify-center h-[324px]">
                  ...
                  <div
                    ...
                    style={{
                      opacity: activeTab === 1 ? 100 : 0,
                      scale: activeTab === 1 ? 100 : 125,
                      transition:
                        "opacity 0.7s ease-[cubic-bezier(0.38,0,0.32,1)], scale 0.7s ease-[cubic-bezier(0.38,0,0.32,1)]",
                    }}
                    x-show={activeTab === 1}
                  ...
                  <div
                    ...
                    style={{
                      opacity: activeTab === 2 ? 100 : 0,
                      scale: activeTab === 2 ? 100 : 125,
                      transition:
                        "opacity 0.7s ease-[cubic-bezier(0.38,0,0.32,1)], scale 0.7s ease-[cubic-bezier(0.38,0,0.32,1)]",
                    }}
                  >
                  ...
                  <div
                    ...
                    style={{
                      opacity: activeTab === 3 ? 100 : 0,
                      scale: activeTab === 3 ? 100 : 125,
                      transition:
                        "opacity 0.7s ease-[cubic-bezier(0.38,0,0.32,1)], scale 0.7s ease-[cubic-bezier(0.38,0,0.32,1)]",
                    }}
                  >
                  ...
                  <div
                    ...
                    style={{
                      opacity: activeTab === 4 ? 100 : 0,
                      scale: activeTab === 4 ? 100 : 125,
                      transition:
                        "opacity 0.7s ease-[cubic-bezier(0.38,0,0.32,1)], scale 0.7s ease-[cubic-bezier(0.38,0,0.32,1)]",
                    }}
                  >
