                  ...
                  <div className="py-16 md:py-20">
                    ...
                    <form>
                      ...
                      <div className="space-y-3 mt-6">
                        ...
                        <div className="italic text-sm text-gray-400 text-center">
                          Or
                        </div>
                        <button className="btn text-white bg-gradient-to-t from-gray-900 to-gray-700 bg-[length:100%_100%] hover:bg-[length:100%_150%] bg-[bottom] shadow w-full">
                    ...
                    <div className="text-center mt-6">
                      <p className="text-sm text-gray-500">
                        ...
                        <a
                          className="font-medium text-gray-700 underline hover:no-underline whitespace-nowrap"
                          href="#0"
                        >
                          Terms of Service
                        </a>
