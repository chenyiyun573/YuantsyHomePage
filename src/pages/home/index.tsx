            ...
            <div className="text-center pb-12 md:pb-16">
              ...
              <div className="max-w-3xl mx-auto">
                <p
                  ...
                  data-aos-delay="300"
                >
                  Yuantsy Desktop Agent is an AI powered remote control software
                  that can help you to do anything you can do with a computer.
                </p>
      ...
      <section>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            Knowledge Tree
            <br className="max-lg:hidden" />
            Simplify the world you live in.
          </h1>
          <p
            className="text-lg text-gray-700 mb-8"
            data-aos="zoom-y-out"
            data-aos-delay="300"
          >
            Know the world better. Knowledge Tree will be the knowledge platform
            both for agentic AIs and human beings.
          </p>
                  ...
                  (label, index) => {
                    ...
                    return (
                      <button
                        key={tabIndex}
                        id={`tab-${tabIndex}`}
                        className={`flex-1 flex items-center gap-2.5 text-sm font-medium h-8 px-3 rounded-lg whitespace-nowrap focus-visible:outline-none focus-visible:ring focus-visible:ring-blue-300 transition-colors ${
                          activeTab === tabIndex
                          ...
                          <path
                            d={
                              tabIndex === 1
                                ...
                                : tabIndex === 2
                                ? "M5.936.278A7.983 7.983 0 0 1 8 0a8 8 0 1 1-8 8c0-.722.104-1.413.278-2.064a1 1 0 1 1 1.932.516A5.99 5.99 0 0 0 2 8a6 6 0 1 0 6-6c-.53 0-1.045.076-1.548.21A1 1 0 1 1 5.936.278Zm.132 7.204A2.003 2.003 0 0 0 8 10a2 2 0 1 0-.518-3.932L3.707 2.293a1 1 0 0 0-1.414 1.414l3.775 3.775Z"
                                : tabIndex === 3
                                ? "M3 2a1 1 0 0 0-2 0v12a1 1 0 1 0 2 0V2Zm4 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm4 12a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm-5 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm5-13a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm4 0a1 1 0 1 0-2 0v12a1 1 0 1 0 2 0V2Z"
                                : "M.06 10.003a1 1 0 0 1 1.947.455c-.019.08.01.152.078.19l5.83 3.333c.052.03.115.03.168 0l5.83-3.333a.163.163 0 0 0 .078-.188 1 1 0 1 1 1.947-.459 2.161 2.161 0 0 1-1.032 2.384l-5.83 3.331a2.168 2.168 0 0 1-2.154 0l-5.83-3.331A2.162 2.162 0 0 1 .06 10.003Zm7.855-7.981-5.83 3.332a.17.17 0 0 0 0 .295l5.828 3.33a.172.172 0 0 0 .17.002l5.83-3.333a.17.17 0 0 0 0-.294L8.084 2.023a.172.172 0 0 0-.17-.001h.001ZM9.075.285l5.83 3.332c1.458.833 1.458 2.935 0 3.768l-5.83 3.333c-.667.38-1.485.38-2.153-.001l-5.83-3.332c-1.457-.833-1.457-2.935 0-3.767L6.924.285a2.173 2.173 0 0 1 2.15 0h.001Z"
                            }
                          />
                        </svg>
                        <span>{label}</span>
          ...
          <div className="py-12 md:py-20">
            <div className="max-w-3xl mx-auto text-center pb-16 md:pb-20">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-200">
                AI models, all in one - Yuantsy Service Platform{" "}
              </h2>
            </div>
          ...
          <div className="py-12 md:py-20">
            <div className="max-w-3xl mx-auto text-center pb-24 md:pb-28">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Reorganize the World <br /> Yuantsy RAG Search
              </h2>
            ...
            <div
              className="group relative w-full max-w-[500px] mx-auto flex justify-center mb-32 md:mb-36"
              data-aos="zoom-y-out"
            >
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold">
                Yuantsy Neural Engine <br /> Agentic AI calls new Hardware.
              </h2>
            </div>
          </div>
          <div className="relative flex justify-center max-w-[94rem] mx-auto">
            <div
              className="absolute bottom-20 -translate-x-36 -z-10"
              aria-hidden="true"
            >
            ...
            <div
              ...
              className="w-full inline-flex flex-nowrap [mask-image:_linear-gradient(to_right,transparent_0,_black_10%,_black_90%,transparent_100%)] py-12 md:py-20 group"
            >
              <div
                x-ref="testimonials"
                className="flex items-start justify-center md:justify-start [&>*]:mx-3 animate-[infinite-scroll_60s_linear_infinite] group-hover:[animation-play-state:paused]"
              >
                <article className="relative flex flex-col rounded-2xl h-full w-[22rem] p-5 shadow-lg odd:rotate-1 even:-rotate-1 group-hover:rotate-0 transition-transform duration-300 bg-white/70 shadow-black/[0.03] before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(theme(colors.gray.100),theme(colors.gray.200))_border-box] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] before:[mask-composite:exclude_!important] before:pointer-events-none">
                ...
                <article className="relative flex flex-col rounded-2xl h-full w-[22rem] p-5 shadow-lg odd:rotate-1 even:-rotate-1 group-hover:rotate-0 transition-transform duration-300 bg-white/70 shadow-black/[0.03] before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(theme(colors.gray.100),theme(colors.gray.200))_border-box] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] before:[mask-composite:exclude_!important] before:pointer-events-none">
                  ...
                  <div className="grow text-sm text-gray-700">
                    I've tried several website builders before, but none were as
                    user-friendly and versatile as this one. From design to
                  ...
                  <footer className="mt-4 text-gray-700 flex items-center gap-2.5">
                    ...
                    <div className="text-xs">Mar 04, 2027</div>
                  </footer>
                </article>
                <article className="relative flex flex-col rounded-2xl h-full w-[22rem] p-5 shadow-lg odd:rotate-1 even:-rotate-1 group-hover:rotate-0 transition-transform duration-300 bg-white/70 shadow-black/[0.03] before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(theme(colors.gray.100),theme(colors.gray.200))_border-box] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] before:[mask-composite:exclude_!important] before:pointer-events-none">
                  <header className="flex items-center gap-3 mb-4">
                  ...
                  <footer className="mt-4 text-gray-700 flex items-center gap-2.5">
                    ...
                    <div className="text-xs">Jan 15, 2027</div>
                  </footer>
                </article>
              </div>
            </div>
