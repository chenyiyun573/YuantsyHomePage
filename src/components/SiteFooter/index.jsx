const SiteFooter = () => {
  return (
    <footer>
      ...
      <div style={{ position: 'relative', width: '100%', textAlign: 'center', fontSize: '250px', fontWeight: 'bold', color: 'transparent', background: 'linear-gradient(to bottom, #ddd, #fff 50%)', filter: 'drop-shadow(5px 5px 10px rgba(0, 0, 0, 0.1))', WebkitBackgroundClip: 'text' }}>
        Yuantsy
      </div>
